...
Consult when the diff includes code in these languages. Referenced from the Code Review skill (`SKILL.md`). Apply within the Correctness, Standards, and Security axes.
