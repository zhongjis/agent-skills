...
For React components (`.tsx`, `.jsx`, or React API imports), also load `react-best-practices`; this reference owns TypeScript fundamentals, not React effects, hooks, refs, or component design.
...
| `noUncheckedSideEffectImports` | Missing or mistyped side-effect imports |
